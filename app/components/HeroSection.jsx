            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    ...
                    <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
                        A self-taught Python developer with a Experienced in backend development using Django and
                        FastAPI Skilled in working with databases, message brokers, and DevOps tools.
                    </p>
                    <div>
                        <Link
                            href="/#contact"
